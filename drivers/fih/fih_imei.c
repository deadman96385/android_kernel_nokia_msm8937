...
#define FIH_PROC_IMEI_PATH  "AllHWList/imei"
...
/*imei*/
/*Backup imei into deviceinfo partition*/
void fih_imei_setup(char *info)
{
  struct file *fp = NULL;
  mm_segment_t oldfs = get_fs();
	...
	fp->f_op->llseek(fp, IMEI_OFFSET, SEEK_SET);
...
ssize_t imei_proc_write(struct file *file, const char  __user *buffer,
...
{
	if (proc_create(FIH_PROC_IMEI_PATH, 0644, NULL, &imei_file_ops) == NULL) {
