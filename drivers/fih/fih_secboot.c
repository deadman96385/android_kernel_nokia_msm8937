...
#define SECBOOT_ENABLED_MEM_ADDR  0x000A01D0  //jason add for get fused status
#define SECBOOT_ENABLED_MEM_MASK  0x00303030
#define SECBOOT_ENABLED_MEM_VALUE  0x00303030 //jason add for get fused status

#define SECBIIT_SERIAL_NO_ADDR  0x000A4128 //QFPROM_CORR_SERIAL_NUM in 80-NT667-2X rev.E
