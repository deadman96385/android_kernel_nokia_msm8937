...
enum usb_chg_type {
	...
	USB_UNSUPPORTED_CHARGER, // FIHTDC, IdaChiang, for floated charger
};
...
struct msm_otg_platform_data {
  ...
  enum floated_chg_type enable_floated_charger; // FIHTDC, IdaChiang, for floated charger
};
...
#define PHY_REGULATORS_LPM	BIT(4)
	...
	bool is_ext_chg_dcp;
	bool is_ext_chg_detected; // FIHTDC, IdaChiang, for floated charger
...
#define DEBUG_MAX_MSG   256UL
	...
	unsigned int chg_retry_count; // FIHTDC, IdaChiang, for floated charger
};
